...
model_name = 'thu_nghiem_1_classification_CNN_Feature_ResNet50_FC2'
...
# ====================================================================    
train_folder = os.path.join(directory_feature, 'Feature_ResNet50_FC2_train')
test_folder = os.path.join(directory_feature, 'Feature_ResNet50_FC2_test')
