...
model_name = 'thu_nghiem_1_classification_CNN_Feature_VGG16_FC2'
...
# ====================================================================    
train_folder = os.path.join(directory_feature, 'Feature_VGG16_FC2_train')
test_folder = os.path.join(directory_feature, 'Feature_VGG16_FC2_test')
