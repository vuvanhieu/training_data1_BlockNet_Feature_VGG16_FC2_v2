...
model_name = 'thu_nghiem_1_classification_CNN_Feature_EfficientNetB0_FC2'
...
# ====================================================================    
train_folder = os.path.join(directory_feature, 'EfficientNetB0_FC2_train')
test_folder = os.path.join(directory_feature, 'EfficientNetB0_FC2_test')
